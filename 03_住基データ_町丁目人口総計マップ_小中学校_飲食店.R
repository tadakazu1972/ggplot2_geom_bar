...
shape <- st_read(dsn = "~/Desktop/ggplot2_geom_bar/shape/", layer = "h27ka27116")

#住民基本台帳csv読込
data1 <- read_csv("./jyuki_ikuno_202003.csv")
...
#生野区のデータのみ抽出
eat <- eat %>% filter(eat$区=="生野")

#######################################################
#pngファイル版
{
  quartz(type="png", file=sprintf("生野区_住基202003_総数_小中学校_飲食.png"), dpi=144, bg="white")
