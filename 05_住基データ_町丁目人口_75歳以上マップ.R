...
shape <- st_read(dsn = "~/Desktop/ggplot2_geom_bar/shape/", layer = "h27ka27114")
...
#pngファイル版
{
  quartz(type="png", file=sprintf(paste(kuname, "_住基202003_75歳以上.png", sep="")), dpi=144, bg="white")
  ...
  #境界
  plot(st_geometry(shape[7]), col=col_km, main=paste(kuname, "　人口　75歳以上 (住民基本台帳 2020年3月末現在)", sep=""))
